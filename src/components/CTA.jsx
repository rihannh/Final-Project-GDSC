    ...
    <section id='cta' className='mt-24'>
      <div className="container">
        <ShineBorder className="flex relative overflow-hidden flex-col lg:text-center justify-between items-center bg-slate-900 rounded-xl p-8 lg:p-16 gap-8" color={["#A07CFE", "#FE8FB5", "#FFBE7B"]}>
          ...
          <Link className="z-10" to='/bmi-check'>
            <button className="text-slate-800 md:text-lg bg-cyan-500 py-2 px-6 md:py-3 w-fit h-fit md:px-16 rounded-full hover:scale-110 hover:shadow-xl hover:shadow-cyan-500/30 duration-300">Mulai Sekarang</button>
          </Link>
        </ShineBorder>
        <div className="flex flex-col lg:flex-row justify-between py-12 md:py-[72px] mt-32 gap-y-6 lg:gap-y-0">
          ...
          <div className="space-x-2 md:space-x-6">
            <button className="text-white text-lg md:text-2xl border-[3px] border-cyan-500 bg-cyan-500 py-2 px-6 md:py-3  md:px-8 rounded-full hover:bg-transparent hover:text-cyan-500 duration-300"><a href="#service">Telusuri</a></button>
            <Link to='/contact'>
